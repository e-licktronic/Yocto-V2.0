...
prog_char txt_INST0[] PROGMEM   =" BD";
prog_char txt_INST1[] PROGMEM   =" SD";
prog_char txt_INST2[] PROGMEM   =" LT";
prog_char txt_INST3[] PROGMEM   =" MT";
prog_char txt_INST4[] PROGMEM   =" HT";
prog_char txt_INST5[] PROGMEM   =" RM";
prog_char txt_INST6[] PROGMEM   =" CP";
prog_char txt_INST7[] PROGMEM   =" CB";
prog_char txt_INST8[] PROGMEM   =" CY";
prog_char txt_INST9[] PROGMEM   =" OH";
prog_char txt_INST10[] PROGMEM  =" CH";
prog_char txt_INST11[] PROGMEM  ="PC2";
prog_char txt_INST12[] PROGMEM  ="ACC";
prog_char txt_INST13[] PROGMEM  ="EXT";
prog_char txt_INST14[] PROGMEM  ="TR1";
prog_char txt_INST15[] PROGMEM  ="TR2";
